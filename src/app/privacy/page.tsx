      ...
      <section className="container mx-auto px-4 pb-20">
        <div className="font-light lg:w-[1000px] mx-auto text-lg">
          <h2 className="text-[1rem] lg:text-[1.5rem] font-[400] tracking-[0.5px]!">
            ...
            your personal information when you visit our website and engage with
            our services.
          </h2>
          ...
          <ul className="mt-8 list-[square]">
            ...
            <div className="space-y-4 pl-10 mt-2">
              ...
              <li>
                To personalize your learning experience and improve our courses.
              </li>
              <li>
          ...
          <div className="mt-8">
            ...
            <p>
              ...
              service providers who assist us in delivering our services, under
          ...
          <div className="mt-8">
            ...
            <p>
              We may use cookies to enhance your experience on our Site. You can
